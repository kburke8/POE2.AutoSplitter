...
namespace POE2.AutoSplitter.Component.Settings
{
    public class ComponentSettings
    {
        ...
        private const string DEFAULT_LOG_LOCATION = @"G:\Source\POE2.AutoSplitter\POE2.AutoSplitter\Component\test-data\Client.txt";
            ...
            try
            {
                ...
                if (!element.IsEmpty)
                {
                    ...
                    if (element[SPLIT_ZONES] != null)
                    {
                        ...
                        {
                            SplitZoneLevels.Add(int.Parse(child.InnerText));
                        }
                    }
                    if (element[SPLIT_LEVELS] != null)
                    {
                        ...
                        {
                            SplitLevels.Add(int.Parse(child.InnerText));
                        }
                    }
